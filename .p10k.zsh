# Generated by Powerlevel10k configuration wizard on 2020-10-29 at 12:02 JST.
...
# https://github.com/Powerlevel9k/powerlevel9k/blob/master/functions/colors.zsh
...
() {
  ...
  typeset -g POWERLEVEL9K_CUSTOM_GIT_PAIR_BACKGROUND="clear"
  typeset -g POWERLEVEL9K_CUSTOM_GIT_PAIR_FOREGROUND="blue"
  ...
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND='orange1'

  typeset -g POWERLEVEL9K_VIRTUALENV_BACKGROUND='clear'
  typeset -g POWERLEVEL9K_VIRTUALENV_FOREGROUND='orange1'
